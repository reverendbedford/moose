# Large-step (dt = 0.5) 2D axisymmetric finite-strain plasticity Hertz.
# Same physics as hertz_sphere_inelastic_finite but stepped in two large
# increments to force Newton onto the nonmonotone Armijo (Grippo-Lampariello-
# Lucidi) semismooth line-search path.  All contact quantities go through the
# analytic-level-set nodal-NCP stack.
...
[Executioner]
  ...
  start_time = 0.0
  end_time   = 1.0    # 2 steps at dt=0.5 exercises the semismooth linesearch
  dt         = 0.5
[]
